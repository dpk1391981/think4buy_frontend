...
const SERVICES: Record<string, {
  ...
  'vastu-consultation': {
    ...
    emoji: '🧿',
    tagline: 'Align your home with positive energy & prosperity',
    description: 'Consult India\'s certified Vastu Shastra experts for your home, office, or plot. Get personalized Vastu analysis, remedies, and design recommendations to attract wealth, health, and harmony.',
    color: 'border-amber-200',
    bgColor: 'bg-amber-50',
    textColor: 'text-amber-700',
    features: [
      { title: 'Home Vastu Analysis', desc: 'Complete Vastu audit for your home — room-by-room assessment with actionable remedies.' },
      { title: 'Plot & Land Analysis', desc: 'Evaluate plot direction, shape, and surroundings before purchase to ensure positive energy flow.' },
      { title: 'Office & Commercial', desc: 'Boost business growth with Vastu-aligned office layouts, desk placements, and entrance design.' },
      { title: 'New Construction Plans', desc: 'Review architectural plans before construction to ensure Vastu compliance from the ground up.' },
      { title: 'Remedies Without Demolition', desc: 'Practical Vastu corrections using colors, crystals, and furniture placement — no breaking walls.' },
      { title: 'Online & Doorstep Visits', desc: 'Book a video consultation or request a certified expert to visit your property in person.' },
    ],
    faqs: [
      { q: 'What is Vastu Shastra?', a: 'Vastu Shastra is an ancient Indian science of architecture and space arrangement that harmonizes the five elements (earth, water, fire, air, space) to promote well-being and prosperity.' },
      { q: 'Can Vastu defects be corrected without renovation?', a: 'Yes. Most Vastu issues can be remedied without structural changes using directional corrections, mirrors, colors, plants, and specific placement of objects.' },
      { q: 'Is online Vastu consultation effective?', a: 'Absolutely. With floor plan images and directional photos, our experts provide the same level of analysis remotely as an in-person visit.' },
      { q: 'When should I consult a Vastu expert?', a: 'Ideally before buying a property, before construction begins, or when you notice persistent issues like financial stress, health problems, or relationship discord at home.' },
    ],
    partners: ['Vastu Devayah', 'AstroSage', 'Ganeshaspeaks', 'Vastu Plus', 'SciVastu', 'Jyotish Sangh'],
    cta: 'Book Free Consultation',
    ctaPhone: '1800-789-0123',
  },
  'property-management': {
    name: 'Property Management',
    emoji: '🏢',
    tagline: 'Hassle-free rental income — we manage everything',
    description: 'Let our professional property managers handle your rental property end-to-end. From tenant finding and rent collection to maintenance and legal compliance — maximize returns while you relax.',
    color: 'border-indigo-200',
    bgColor: 'bg-indigo-50',
    textColor: 'text-indigo-700',
    features: [
      { title: 'Tenant Finding', desc: 'We screen, verify, and onboard quality tenants — background checks and rental history included.' },
      { title: 'Rent Collection', desc: 'Automated monthly rent collection with timely owner disbursement and online tracking.' },
      { title: 'Maintenance Management', desc: '24/7 maintenance coordination with verified vendors — repairs, cleaning, and upkeep handled.' },
      { title: 'Legal & Documentation', desc: 'Rental agreement drafting, police verification, and full compliance with local tenancy laws.' },
      { title: 'Property Inspection', desc: 'Regular quarterly inspections with detailed reports and photos sent to the owner.' },
      { title: 'NRI Landlord Services', desc: 'Complete hands-off management for NRI owners — regular updates and transparent accounting.' },
    ],
    faqs: [
      { q: 'What does property management include?', a: 'Our full-service plan covers tenant sourcing, agreement, rent collection, maintenance, inspections, and legal compliance — everything from vacancy to exit.' },
      { q: 'How much does property management cost?', a: 'Fees typically range from 8-10% of monthly rent for full management. We also offer standalone services like tenant finding or rent collection.' },
      { q: 'What if a tenant stops paying rent?', a: 'We follow up promptly, initiate legal notice procedures if needed, and help you find a replacement tenant quickly to minimize vacancy loss.' },
      { q: 'Is this service available for NRIs?', a: 'Yes. We specialize in NRI property management with regular photo updates, digital rent transfer, and dedicated relationship managers.' },
    ],
    partners: ['NestAway', 'Homzmart', 'Rentomojo', 'Square Yards', 'Stayabode', 'NoBroker Hood'],
    cta: 'Start Managing My Property',
    ctaPhone: '1800-890-1234',
  },
  'property-insurance': {
