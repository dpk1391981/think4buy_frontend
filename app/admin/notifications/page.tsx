    ...
    <div className="p-4 sm:p-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
            className="flex items-center gap-1.5 text-sm text-orange-600 font-semibold hover:text-orange-800"
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {!n.isRead && <span className="w-2.5 h-2.5 rounded-full bg-orange-500 flex-shrink-0 mt-1" />}
                </div>
