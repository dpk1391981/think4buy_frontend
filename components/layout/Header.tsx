  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain min-h-0">
          ...
          <div className="border-b border-gray-100">
            ...
            >
              ...
              <span className="ml-auto text-xs font-medium text-primary-600 mr-1">{selectedCity || 'All Cities'}</span>
              <ChevronDown className={cn('w-3.5 h-3.5 text-gray-400 transition-transform flex-shrink-0', cityOpen && 'rotate-180')} />
            </button>
            {cityOpen && (
        ...
        {/* Sign out — always pinned at bottom, above mobile bottom nav */}
        <div className="border-t border-gray-100 p-4 pb-20 flex-shrink-0">
          <button
            onClick={handleLogout}
            className="flex items-center gap-3 w-full px-4 py-3.5 text-sm font-semibold text-red-600 bg-red-50 hover:bg-red-100 rounded-xl transition-colors border border-red-100"
          >
